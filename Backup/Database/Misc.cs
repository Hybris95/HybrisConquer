...
namespace ConquerServer_Basic
{
    public class Misc
    {
        ...
        static public void LoadSkills()
        {
            ...
            GetSkillDictionary:
                ...
                else
                {
                    ...
                    Kernel.Skills.Add(skill.ID, skills);
                    goto GetSkillDictionary;
                }
            }
        ...
        static public void LoadExp()
        {
            ...
            Console.WriteLine("Level experience requirements loaded.");
        }
        static public void LoadWepExp()
        {
            ...
            Console.WriteLine("Weapon experience requirements loaded.");
        }
    }
}
